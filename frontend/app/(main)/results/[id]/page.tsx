...
export default function ResultsPage() {
  ...
  const handleShare = async () => {
    ...
    const title = "DiabeVision – Analysis Report";
  ...
  const handleExportReport = async () => {
    ...
    try {
      ...
      doc.text("DiabeVision – Diabetic Retinopathy Report", margin, y);
      y += 10;
      ...
      doc.setFontSize(8);
      doc.setTextColor(100, 116, 139);
      doc.text("This report was generated by DiabeVision. Clinical correlation is recommended.", margin, y);

      doc.save(`DiabeVision-Report-${analysis.patientId}-${analysis.date.slice(0, 10)}.pdf`);
    } catch (err) {
      console.error(err);
    } finally {
      setExporting(false);
